...
from campusfy.core.views import core
from campusfy.users.views import users
from campusfy.blog_posts.views import blog_posts
from campusfy.error_pages.handlers import error_pages
